        ...
        <section className="links pt-3" data-aos="fade-right">
          <div className="container  text-md-start mt-5">
            ...
            <div className="row mt-3">
              ...
              {/* <!-- Grid column --> */}
              <div
                className="products col-md-2 col-lg-2 col-xl-2 mx-auto mb-4"
                style={{ color: "black" }}
              >
                {/* <!-- Links --> */}
                ...
                <p>
                  <a
                    ...
                    id="textdec"
                    href="https://threadzapparel.netlify.app/"
                    target="blank"
                  >
                    VIN Lookup
                  </a>
                ...
                <p>
                  <a
                    href="https://shawlinkenterprise.netlify.app/"
                    className="text-reset"
                    id="textdec"
                    target="blank"
                  >
                ...
                <p>
                  <a
                    href="https://aesthetic-gelato-6ac4b5.netlify.app/"
                    className="text-reset"
                    id="textdec"
                    target="blank"
                  >
              ...
              <div className="products col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                {/* <!-- Links --> */}
                <h6 className="text-uppercase fw-bold mb-4">IMPORTANTS</h6>
                <p>
                  <NavLink
                    href="#!"
                    className="text-reset"
              ...
              <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                {/* <!-- Links --> */}
                <h6 className="text-uppercase fw-bold mb-4" id="fotcon">
                  Contact
                </h6>
                <p id="textdec">
                  <i className="fas fa-home me-3"></i>{" "}
                  VinccheckCentral@gmail.com
                </p>
                <p id="textdec">
                ...
                <p>
                  <i className="fas fa-phone me-3"></i> +9234-12345678
                </p>
                <p>
                  <i className="fas fa-print me-3"></i> +9231-12345678
                </p>
              </div>
              {/* <!-- Grid column --> */}
            </div>
