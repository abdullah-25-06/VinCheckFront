    ...
    return (
        <>
            <div className="col-xxl-10 col-xl-10 col-lg-10 col-md-11 col-sm-11 mx-auto automation" data-aos='fade-right'>
                    <h1 className='text-center' >VIN CHECK CENTRAL vs CarFax & others</h1>
                    <h4 className='text-center pt-1'>DO NOT OVERPAY!</h4>
                    <h4 className='text-center pt-1'>CHOOSE VIN CHECK CENTRAL — THE SERVICE YOU CAN EASILY RELY ON!</h4>
