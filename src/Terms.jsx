    ...
    return (
        <>
            ...
            <div className="delivery">
                <div className='dt'>
                    <p>
                        Welcome to Vin Check Central, which Vin Check Central  (“we”, “us”, “our”) owns. To remain on this site and access its features, we ask that you agree to comply with our Terms of Service. Along with the NMVTIS Disclaimer and Privacy Policy , our Terms of Service define your interactions with this website.
                    </p>
                </div>
            ...
            <div className="delivery">
                ...
                <div className="dt">
                    <p style={{ fontSize: '15px' }}>
                        This document is a legal agreement between you and Vin Check Central  that outlines the rules dictating how you may use our products and services, (“Services,”) which are made available through our Website, Vin Check Central. Any use of the Website, products, or services constitutes an acceptance by you to be bound by these Terms.
                        <br />
                        We may update these Terms at our discretion and from time to time, which may include future terms, licenses, and other policies or procedures. In such an event we will notify you through email and by prominently posting a notice to the Website. Do not use our Services if you do not agree to such changes. If you continue to use Vin Check Central after any posted changes your use will indicate your agreement to the modified Terms.
                        <br />
                ...
                <div className="dt">
                    <p style={{ fontSize: '15px' }} >
                        ...
                        <br />
                        <b>5. secure the integrity of Vin Check Central , its users, and the public</b>
                        <br />
                        <b>TERMINATION</b>: In addition to altering these Terms at any time, Vin Check Central  also may terminate its Services at any time and/or your use thereof, with or without cause
                    </p>
                </div>
                <div className="dt" id='ds'>
                    <h6 >6. WHAT Vin Check Central  EXPECTS FROM YOU
                    </h6>
                </div>
                <div className="dt">
                    <p style={{ fontSize: '15px' }}>1. You are required to have an Vin Check Central  account to use our Services. We generally limit registrations to unique individuals, and account transfers are typically not granted.
                        <br />
                        ...
                        <br />
                        5. If you breach the Terms of Service or are late on a payment, resulting in your account being suspended or terminated, Vin Check Central  reserves the right to suspend or terminate any account that you or anyone associated with your organization have
                        <br />
                        6. To retain access and maintain your electronic records, you may need to have specific hardware and software. By submitting data to Vin Check Central, you acknowledge your agreement to abide by our terms of service and pay for transactions you agree to take part in on our website. This includes notices of cancellation, contacts, applications, and policies
                        <br />
                        7. You will not rely on an Vin Check Central report as the sole basis for a vehicle purchasing decision
                        <br />
                    </p>
                </div>
                <div className="dt" id='ds'>
                ...
                <div className="dt">
                    <p style={{ fontSize: '15px' }}>1. We reserve that right to change prices and the availability of our Services at any time
                        ...
                        <br />
                        3. We may change our billing methods or fees at any time. Clients with a monthly subscription for Vin Check Central  services will be given 30 days’ notice via our Terms of Service posted on Vin Check Central
                        <br />
                        ...
                        <br />
                        6. Charges or fees of any sort that you incur via a third-party linked to on Vin Check Central are your responsibility
                        <br />
                    </p>
                </div>
                <div className="dt" id='ds'>
                ...
                <div className="dt">
                    <p style={{ fontSize: '15px' }}>Vin Check Central  operates its services from offices located in the United States. Your use of our Services affirms that you comply with all applicable laws, statutes, ordinances, and regulations.
                    </p>
                </div>
                <div className="dt" id='ds'>
                ...
                <div className="dt">
                    <p style={{ fontSize: '15px' }}>We may use any means we feel necessary to enact all terms of service in this agreement. This includes Vin Check Central 's need to comply with all related legal processes. Your use of Vin Check Central 's services means you submit to us the right to disclose any volunteered information to law enforcement authorities, municipal entities, or others reasonably necessary for compliance purposes without liability to you.
                    </p>
                </div>
                <div className="dt" id='ds'>
